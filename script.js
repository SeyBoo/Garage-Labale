function menuToggleOn() {
    ...
    document.querySelector(".nav-menu-bar-1").style.transition = "all 1.5s";
    setTimeout(function() {
    ...
    setTimeout(function() {
        ...
        document.querySelector(".nav-close-bar-1").style.transition = "transform 1.5s";
        document.querySelector(".nav-close-bar-2").style.transform = "rotate(90deg)";
        document.querySelector(".nav-close-bar-2").style.transition = "transform 1.5s";
    }, 500);
}
